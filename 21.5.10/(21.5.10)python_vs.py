...
class man(object):
    ...
    def __str__(self, name, age): 
        return '남자의 이름은 {}, 나이는 {}'.format(self.name, self.age)

    def disp_man(self):
        print('남자의 이름은 {}, 나이는 {}'.format(self.name, self.age))

    def __add__(self, yearpass):
        self.age = self.age + yearpass
        print('{}년이 지난 후 남자의 나이 = {} '.format(yearpass, self.age))
